...
public class EmployeeMapper implements ResultSetMapper<Employee> {
  ...
  public final Employee map(final int idx, final ResultSet rs, final      StatementContext ctx) throws SQLException {
     ...
     * @return Employee
     */
    return new Employee (rs.getInt("EMP_ID"),rs.getString("EMP_NAME"),rs.getString("EMP_EMAIL"),rs.getString("EMP_DEPT_NAME"),rs.getLong("EMP_PHONE_NUMBER"),rs.getDate("EMP_DATE_OF_JOINING"),rs.getInt("EMP_LEAVEBALANCE"),rs.getInt("EMP_MANAGER_ID"));
  }
}
